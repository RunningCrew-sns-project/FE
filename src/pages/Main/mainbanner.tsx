      ...
      <div className="relative  h-screen flex items-center  justify-start">
        ...
        {/* 타이틀 */}
          <div className="absolute  text-white ml-8  tablet:ml-16 laptop:ml-36 desktop:ml-36 ">
              ...
              <h1 className="font-kbo text-4xl  w-64  laptop:w-auto desktop: w-auto laptop:text-6xl desktop:text-6xl mb-4 mt-4">{slide.title}</h1>
              {state === 'running' && slide.btn === '시작하기' ? 
                (
                  <div className="relative flex items-center mt-8">
                    <span className="bg-white text-black px-4 py-2 rounded-xl">타이틀제목 인원수</span>
                ...
                <Button theme="primary" className="text-lg font-pre900">{slide.btn}</Button>}
          </div>
